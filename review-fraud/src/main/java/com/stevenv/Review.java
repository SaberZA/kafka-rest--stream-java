...
public class Review extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = -8100184923915370964L;
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Review\",\"namespace\":\"com.stevenv\",\"fields\":[{\"name\":\"id\",\"type\":\"long\",\"doc\":\"Review ID as per Udemy's db\"},{\"name\":\"title\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"content\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"Review text if provided\",\"default\":null},{\"name\":\"rating\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"review value\"},{\"name\":\"created\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"modified\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"user\",\"type\":{\"type\":\"record\",\"name\":\"User\",\"fields\":[{\"name\":\"title\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"first name\"},{\"name\":\"display_name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}},{\"name\":\"course\",\"type\":{\"type\":\"record\",\"name\":\"Course\",\"fields\":[{\"name\":\"id\",\"type\":\"long\",\"doc\":\"Course ID in Udemy's DB\"},{\"name\":\"title\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"url\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}}]}");
    ...
    /** review value */
    @Deprecated public java.lang.String rating;
    @Deprecated public org.joda.time.DateTime created;
    @Deprecated public org.joda.time.DateTime modified;
    @Deprecated public com.stevenv.User user;
    @Deprecated public com.stevenv.Course course;
     ...
     */
    public Review(java.lang.Long id, java.lang.String title, java.lang.String content, java.lang.String rating, org.joda.time.DateTime created, org.joda.time.DateTime modified, com.stevenv.User user, com.stevenv.Course course) {
        this.id = id;
        this.title = title;
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            ...
            case 3: rating = (java.lang.String)value$; break;
            case 4: created = (org.joda.time.DateTime)value$; break;
            case 5: modified = (org.joda.time.DateTime)value$; break;
            case 6: user = (com.stevenv.User)value$; break;
            case 7: course = (com.stevenv.Course)value$; break;
            default: throw new org.apache.avro.AvroRuntimeException("Bad index");
        }
    }
     ...
     */
    public com.stevenv.User getUser() {
        return user;
    }
     ...
     * @param value the value to set.
     */
    public void setUser(com.stevenv.User value) {
        this.user = value;
    }
     ...
     */
    public com.stevenv.Course getCourse() {
        return course;
    }
     ...
     * @param value the value to set.
     */
    public void setCourse(com.stevenv.Course value) {
        this.course = value;
    }
     ...
     */
    public static com.stevenv.Review.Builder newBuilder() {
        return new com.stevenv.Review.Builder();
    }
     ...
     * @return A new Review RecordBuilder
     */
    public static com.stevenv.Review.Builder newBuilder(com.stevenv.Review.Builder other) {
        return new com.stevenv.Review.Builder(other);
    }
     ...
     * @return A new Review RecordBuilder
     */
    public static com.stevenv.Review.Builder newBuilder(com.stevenv.Review other) {
        return new com.stevenv.Review.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Review>
        ...
        private com.stevenv.User user;
        private com.stevenv.User.Builder userBuilder;
        private com.stevenv.Course course;
        private com.stevenv.Course.Builder courseBuilder;
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(com.stevenv.Review.Builder other) {
            super(other);
            ...
            if (other.hasUserBuilder()) {
                this.userBuilder = com.stevenv.User.newBuilder(other.getUserBuilder());
            }
            ...
            if (other.hasCourseBuilder()) {
                this.courseBuilder = com.stevenv.Course.newBuilder(other.getCourseBuilder());
            }
        }
         ...
         * @param other The existing instance to copy.
         */
        private Builder(com.stevenv.Review other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.id)) {
                this.id = data().deepCopy(fields()[0].schema(), other.id);
                fieldSetFlags()[0] = true;
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder setId(long value) {
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder clearId() {
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder setTitle(java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder clearTitle() {
            title = null;
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder setContent(java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder clearContent() {
            content = null;
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder setRating(java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder clearRating() {
            rating = null;
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder setCreated(org.joda.time.DateTime value) {
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder clearCreated() {
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder setModified(org.joda.time.DateTime value) {
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder clearModified() {
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder setUser(com.stevenv.User value) {
         ...
         * @return This builder.
         */
        public com.stevenv.User.Builder getUserBuilder() {
            if (userBuilder == null) {
                if (hasUser()) {
                    setUserBuilder(com.stevenv.User.newBuilder(user));
                } else {
                    setUserBuilder(com.stevenv.User.newBuilder());
                }
            }
            return userBuilder;
        }
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder setUserBuilder(com.stevenv.User.Builder value) {
            clearUser();
            userBuilder = value;
            return this;
        }
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder clearUser() {
            user = null;
            userBuilder = null;
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder setCourse(com.stevenv.Course value) {
         ...
         * @return This builder.
         */
        public com.stevenv.Course.Builder getCourseBuilder() {
            if (courseBuilder == null) {
                if (hasCourse()) {
                    setCourseBuilder(com.stevenv.Course.newBuilder(course));
                } else {
                    setCourseBuilder(com.stevenv.Course.newBuilder());
                }
            }
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder setCourseBuilder(com.stevenv.Course.Builder value) {
            clearCourse();
            courseBuilder = value;
            return this;
        }
         ...
         * @return This builder.
         */
        public com.stevenv.Review.Builder clearCourse() {
            course = null;
            courseBuilder = null;
        ...
        public Review build() {
            try {
                ...
                record.content = fieldSetFlags()[2] ? this.content : (java.lang.String) defaultValue(fields()[2], record.getConversion(2));
                record.rating = fieldSetFlags()[3] ? this.rating : (java.lang.String) defaultValue(fields()[3], record.getConversion(3));
                ...
                if (userBuilder != null) {
                    ...
                    record.user = fieldSetFlags()[6] ? this.user : (com.stevenv.User) defaultValue(fields()[6], record.getConversion(6));
                }
                if (courseBuilder != null) {
                    record.course = this.courseBuilder.build();
                } else {
                    record.course = fieldSetFlags()[7] ? this.course : (com.stevenv.Course) defaultValue(fields()[7], record.getConversion(7));
                }
                return record;
