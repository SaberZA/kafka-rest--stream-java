...
public class Course extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = 2405066816746827410L;
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Course\",\"namespace\":\"com.stevenv\",\"fields\":[{\"name\":\"id\",\"type\":\"long\",\"doc\":\"Course ID in Udemy's DB\"},{\"name\":\"title\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"url\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
     ...
     */
    public Course(java.lang.Long id, java.lang.String title, java.lang.String url) {
        this.id = id;
        this.title = title;
        this.url = url;
    }
     ...
     */
    public static com.stevenv.Course.Builder newBuilder() {
        return new com.stevenv.Course.Builder();
    }
     ...
     * @return A new Course RecordBuilder
     */
    public static com.stevenv.Course.Builder newBuilder(com.stevenv.Course.Builder other) {
        return new com.stevenv.Course.Builder(other);
    }
     ...
     * @return A new Course RecordBuilder
     */
    public static com.stevenv.Course.Builder newBuilder(com.stevenv.Course other) {
        return new com.stevenv.Course.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Course>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(com.stevenv.Course.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(com.stevenv.Course other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.id)) {
                this.id = data().deepCopy(fields()[0].schema(), other.id);
                fieldSetFlags()[0] = true;
         ...
         * @return This builder.
         */
        public com.stevenv.Course.Builder setId(long value) {
         ...
         * @return This builder.
         */
        public com.stevenv.Course.Builder clearId() {
         ...
         * @return This builder.
         */
        public com.stevenv.Course.Builder setTitle(java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.stevenv.Course.Builder clearTitle() {
            title = null;
         ...
         * @return This builder.
         */
        public com.stevenv.Course.Builder setUrl(java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.stevenv.Course.Builder clearUrl() {
            url = null;
